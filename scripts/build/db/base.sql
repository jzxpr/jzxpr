...
INSERT INTO `base_site_config` (`id`, `name`, `value`, `possible_values`, `category`, `ui_type`, `editable`, `hint`, `comment`) VALUES(1, 'site_name', 'jzxpr', NULL, 'global', 'text', '1', 'Site Name', NULL);
